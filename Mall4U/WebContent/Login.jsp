...
<body>
  ...
  <form action="MallAdmin/login" method="post" style="width:50%; border: 1px solid black; padding: 20px; margin: 30px">
  ...
  <a style="text-align:center; font-size:26px" href="http://localhost:8080/Mall4U/CustomerLogin.jsp">Are you a customer ?</a><br><br>

...
<body>
  ...
  <form action="/Mall4U/Customer/Login" method="post" style="width:50%; border: 1px solid black; padding: 20px; margin: 30px">
    <h1 style="text-align: center">Welcome to Mall4U..!</h1><br>
    <div class="form-group">
    	<label class="form-label">Username</label>
      <input name="username" id="username" required="required" class="form-control"/>
    </div><br>
    <div class="form-group">
      <label class="form-label">Password</label>
      <input name="password" id="password" type="password" required="required" class="form-control"/><br>
  ...
  <a style="text-align:center; font-size:26px" href="http://localhost:8080/Mall4U/CustomerRegistration.jsp">Not yet registered ?</a><br><br>
